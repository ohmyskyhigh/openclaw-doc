...
- [Discord bots per agent](https://docs.openclaw.ai/concepts/multi-agent#discord-bots-per-agent)
- [Telegram bots per agent](https://docs.openclaw.ai/concepts/multi-agent#telegram-bots-per-agent)
- [WhatsApp numbers per agent](https://docs.openclaw.ai/concepts/multi-agent#whatsapp-numbers-per-agent)
- [Example: WhatsApp daily chat + Telegram deep work](https://docs.openclaw.ai/concepts/multi-agent#example-whatsapp-daily-chat-%2B-telegram-deep-work)
- [Example: same channel, one peer to Opus](https://docs.openclaw.ai/concepts/multi-agent#example-same-channel-one-peer-to-opus)
...
If a binding sets multiple match fields (for example `peer` \+ `guildId`), all specified fields are required (`AND` semantics).Important account-scope detail:
...
### [​](https://docs.openclaw.ai/concepts/multi-agent\#discord-bots-per-agent)  Discord bots per agent
...
### [​](https://docs.openclaw.ai/concepts/multi-agent\#telegram-bots-per-agent)  Telegram bots per agent
...
### [​](https://docs.openclaw.ai/concepts/multi-agent\#whatsapp-numbers-per-agent)  WhatsApp numbers per agent
...
For group targeting, use `agents.list[].groupChat.mentionPatterns` so @mentions map cleanly to the intended agent.See [Multi-Agent Sandbox & Tools](https://docs.openclaw.ai/tools/multi-agent-sandbox-tools) for detailed examples.
